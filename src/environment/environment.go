...
func SetupTestingEnvironment(carServerUrl string, rentalServerUrl string) {
	setCarServerUrl(carServerUrl)
	setRentalServerUrl(rentalServerUrl)
	environment = readEnvironment()
}
...
func (e *Environment) GetRentalServerUrl() string {
	return e.rentalServerUrl
}
...
func (e *Environment) GetAllowOrigins() []string {
